...
const EXERCISE_ID_ALIASES: Record<string, string> = {
  ...
  'glute-bridge-hold': 'hip-thrust',
  'cable-kickback': 'hip-thrust',
  'fitball-hip-raise': 'hip-thrust',
  'pull-ups': 'pull-up',
  'weighted-pull-ups': 'pull-up',
  'assisted-pullup': 'lat-pulldown',
  ...
  'overhead-tricep-extension': 'triceps-pushdown',
  'skull-crusher': 'triceps-pushdown',
  'close-grip-bench': 'triceps-pushdown',
  dips: 'triceps-pushdown',
  'assisted-dips': 'triceps-pushdown',
  'tricep-kickback': 'triceps-pushdown',
  'plank-leg-lift': 'plank',
  'hyperextension-hold': 'plank',
  'wall-sit': 'plank',
  'v-sit-hold': 'plank',
  'hanging-leg-raise': 'ab-wheel',
  'lying-leg-raise': 'ab-wheel',
